                ...
                <tr>
                    ...
                    <xsl:choose>
                        <xsl:when test="$sortOrder = 'ascending'">
                            <th id="microclimate-value" class="value sort sorted_asc" onclick="SortByValue('microclimate')">Значение</th>
                        </xsl:when>
                        <xsl:otherwise>
                            <th id="microclimate-value" class="value sort sorted_dec" onclick="SortByValue('microclimate')">Значение</th>
                        </xsl:otherwise>
                    </xsl:choose>
