                ...
                <tr>
                    ...
                    <xsl:choose>
                        <xsl:when test="$sortOrder = 'ascending'">
                            <th id="light-value" class="value sort sorted_asc" onclick="SortByValue('light')">Value</th>
                        </xsl:when>
                        <xsl:otherwise>
                            <th id="light-value" class="value sort sorted_dec" onclick="SortByValue('light')">Value</th>
                        </xsl:otherwise>
                    </xsl:choose>
                    <th id="light-date" class="date sort" onclick="SortByDate('light')">Date</th>
                </tr>
            </thead>
            <tbody>
