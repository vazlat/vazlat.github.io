                ...
                <tr>
                    ...
                    <xsl:choose>
                        <xsl:when test="$sortOrder = 'ascending'">
                            <th id="production-unit" class="unit sort sorted_asc" onclick="SortByUnit('production')">Единица измерения</th>
                        </xsl:when>
                        <xsl:otherwise>
                            <th id="production-unit" class="unit sort sorted_dec" onclick="SortByUnit('production')">Единица измерения</th>
                        </xsl:otherwise>
                    </xsl:choose>
